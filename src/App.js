  ...
  return (
    <div className="container mt-3" style={{ maxHeight: "calc(100vh - 260px)", overflowY: "auto" }}>
      ...
      <form>
        ...
        <div className="mb-3">
          <button className="btn btn-primary mt-3" type="button" onClick={() => setView("confirm")}>
            Confirm purchase
          </button> {" "} 
          <button className="btn btn-secondary mt-3" type="button" onClick={() => setView("products")}>Back to Products</button>
        </div>
      </form>
    </div>
  );
